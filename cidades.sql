-- PostgreSQL syntax
-- This file contains brazilian cities to upload into database
...
CREATE TABLE IF NOT EXISTS estado (
  ...
  pais_id int DEFAULT NULL REFERENCES pais(id) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS cidade (
  ...
  estado_id int DEFAULT NULL REFERENCES estado(id) ON DELETE CASCADE ON UPDATE CASCADE
);
